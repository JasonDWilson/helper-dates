...
namespace jwpro.DateHelper.Managers
{
    public class BusinesDateManager
    {
        ...
        public double GetBusinessHours(DateTime from, DateTime to)
        {
            ...
            var businessDayBegin = DateTime.Parse($"{ from.ToShortDateString()} {_config.BusinessDayBegin}");
            ...
            var businessDayEnd = DateTime.Parse($"{ from.ToShortDateString()} {_config.BusinessDayEnd}");
